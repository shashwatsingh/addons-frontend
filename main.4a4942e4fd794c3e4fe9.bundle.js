...
function site_ownKeys(object,enumerableOnly){var keys=Object.keys(object);if(Object.getOwnPropertySymbols){var symbols=Object.getOwnPropertySymbols(object);if(enumerableOnly)symbols=symbols.filter(function(sym){return Object.getOwnPropertyDescriptor(object,sym).enumerable});keys.push.apply(keys,symbols)}return keys}function site_objectSpread(target){for(var i=1,source;i<arguments.length;i++){source=null!=arguments[i]?arguments[i]:{};if(i%2){site_ownKeys(Object(source),!0).forEach(function(key){site_defineProperty(target,key,source[key])})}else if(Object.getOwnPropertyDescriptors){Object.defineProperties(target,Object.getOwnPropertyDescriptors(source))}else{site_ownKeys(Object(source)).forEach(function(key){Object.defineProperty(target,key,Object.getOwnPropertyDescriptor(source,key))})}}return target}function site_defineProperty(obj,key,value){if(key in obj){Object.defineProperty(obj,key,{value:value,enumerable:!0,configurable:!0,writable:!0})}else{obj[key]=value}return obj}var FETCH_SITE_STATUS="FETCH_SITE_STATUS";var LOAD_SITE_STATUS="LOAD_SITE_STATUS";var LOADED_PAGE_IS_ANONYMOUS="LOADED_PAGE_IS_ANONYMOUS";var site_initialState={readOnly:!1,notice:null,loadedPageIsAnonymous:!1};var fetchSiteStatus=function(){return{type:FETCH_SITE_STATUS,payload:{}}};var loadSiteStatus=function(_ref){var readOnly=_ref.readOnly,notice=_ref.notice;return{type:LOAD_SITE_STATUS,payload:{readOnly:readOnly,notice:notice}}};var loadedPageIsAnonymous=function(){return{type:LOADED_PAGE_IS_ANONYMOUS,payload:{}}};function siteReducer(){var state=0<arguments.length&&arguments[0]!==void 0?arguments[0]:site_initialState,action=1<arguments.length?arguments[1]:void 0;switch(action.type){case LOAD_SITE_STATUS:return site_objectSpread({},state,{readOnly:action.payload.readOnly,notice:action.payload.notice});case LOADED_PAGE_IS_ANONYMOUS:return site_objectSpread({},state,{loadedPageIsAnonymous:!0});default:return state;}}
...
//# sourceMappingURL=main.4a4942e4fd794c3e4fe9.bundle.js.map